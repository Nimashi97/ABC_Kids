    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                csound.start();
                Toasty.success(ThiActivity.this, " Yes, It is a Mango", Toast.LENGTH_SHORT).show();
                marks.setText("Score  " + String.valueOf(score + 1));
                Intent intent = new Intent(ThiActivity.this, FouActivity.class);
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                wsound.start();
                Toasty.error(ThiActivity.this, "Try again", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
