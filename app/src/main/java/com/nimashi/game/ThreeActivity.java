...
public class ThreeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        final int score = i.getIntExtra(TwoActivity.EXTRA_NUMBER, 0);
        ...
        correct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                csound.start();
                Toasty.success(ThreeActivity.this, " Yes, It is a Cat ", Toast.LENGTH_SHORT).show();
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                wsound.start();
                Toasty.error(ThreeActivity.this, "Try again", Toast.LENGTH_SHORT).show();
            }
        });
        /*
    ...
    {
        Intent intent =new Intent(ThreeActivity.this,FourActivity.class);
        Toasty.success(this, " Yes, It is a Cat", Toast.LENGTH_SHORT).show();
        startActivity(intent);
    }
