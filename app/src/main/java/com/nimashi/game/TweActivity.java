...
public class TweActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                csound.start();
                Toasty.success(TweActivity.this, " Yes, It is a Lamp", Toast.LENGTH_SHORT).show();
                marks.setText("Score  " + String.valueOf(score + 1));
                Intent intent = new Intent(TweActivity.this, ThiActivity.class);
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                wsound.start();
                Toasty.error(TweActivity.this, "Try again", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
