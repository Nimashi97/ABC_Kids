    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                csound.start();
                Toasty.success(TwentyActivity.this, " Yes, It is a Tree ", Toast.LENGTH_SHORT).show();
                marks.setText("Score  " + String.valueOf(score + 1));
                Intent intent = new Intent(TwentyActivity.this, TwentyoneActivity.class);
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                wsound.start();
                Toasty.error(TwentyActivity.this, "Try again", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
