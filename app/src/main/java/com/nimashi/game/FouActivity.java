...
public class FouActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fou);
        ...
        correct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                csound.start();
                Toasty.success(FouActivity.this, " Yes, It is a Net", Toast.LENGTH_SHORT).show();
                marks.setText("Score  " + String.valueOf(score + 1));
                Intent intent = new Intent(FouActivity.this, FifActivity.class);
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                wsound.start();
                Toasty.error(FouActivity.this, "Try again", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
