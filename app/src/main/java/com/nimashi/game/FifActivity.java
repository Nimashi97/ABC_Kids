    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                csound.start();
                Toasty.success(FifActivity.this, " Yes, It is an Owl", Toast.LENGTH_SHORT).show();
                marks.setText("Score  " + String.valueOf(score + 1));
                Intent intent = new Intent(FifActivity.this, SixtActivity.class);
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                wsound.start();
                Toasty.error(FifActivity.this, "Try again", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
