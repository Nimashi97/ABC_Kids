...
public class NinetActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                csound.start();
                Toasty.success(NinetActivity.this, " Yes, It is a Sun ", Toast.LENGTH_SHORT).show();
                marks.setText("Score  " + String.valueOf(score + 1));
                Intent intent = new Intent(NinetActivity.this, TwentyActivity.class);
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                wsound.start();
                Toasty.error(NinetActivity.this, "Try again", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
