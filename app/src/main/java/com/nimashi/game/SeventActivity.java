...
public class SeventActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                csound.start();
                Toasty.success(SeventActivity.this, " Yes, This is a Queen ", Toast.LENGTH_SHORT).show();
                marks.setText("Score  " + String.valueOf(score + 1));
                Intent intent = new Intent(SeventActivity.this, EighttActivity.class);
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                wsound.start();
                Toasty.error(SeventActivity.this, "Try again", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
