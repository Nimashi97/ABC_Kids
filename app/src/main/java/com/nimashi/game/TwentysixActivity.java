    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                cheer.start();
                Toasty.success(TwentysixActivity.this, " Yes, It is a Zip ", Toast.LENGTH_SHORT).show();
                marks.setText("Score  " + String.valueOf(score + 1));
                Intent intent = new Intent(TwentysixActivity.this, LevelfinActivity.class);
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                wsound.start();
                Toasty.error(TwentysixActivity.this, "Try again", Toast.LENGTH_SHORT).show();
            }
        });
    }
