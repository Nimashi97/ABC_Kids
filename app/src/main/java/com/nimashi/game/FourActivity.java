...
public class FourActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        final int score = i.getIntExtra(ThreeActivity.EXTRA_NUMBER, 0);
        ...
        correct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                csound.start();
                Toasty.success(FourActivity.this, " Yes, It is a Dog ", Toast.LENGTH_SHORT).show();
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                wsound.start();
                Toasty.error(FourActivity.this, "Try again", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
